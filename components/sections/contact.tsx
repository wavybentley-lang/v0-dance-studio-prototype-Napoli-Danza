...
const courseOptions = ["Danza Moderna", "Hip Hop Kids", "Hip Hop Teen", "Hip Hop Advanced", "Pilates", "Flamenco", "Gioco Danza", "Predanza", "Open Class"]
      ...
      <div className="relative overflow-hidden py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 px-4 text-left lg:px-0 lg:text-center">
            <h2 className="mb-4 text-left font-serif text-4xl font-bold text-foreground sm:text-5xl md:text-6xl lg:text-center">Vuoi provare un <span className="text-primary">corso</span>?</h2>
            <p className="max-w-none text-lg text-pretty text-foreground lg:mx-auto lg:max-w-2xl">Scrivici e ti aiutiamo a scegliere il percorso piu adatto a te. Ti rispondiamo con orari, disponibilita e prossimi passi per iniziare.</p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4" id="sedi"><MapPin className="mt-1 h-6 w-6 flex-shrink-0 text-primary" /><div><div className="mb-2 font-semibold text-foreground">Indirizzo</div><div className="text-foreground">Via Amato Di Montecassino, 10/b - zona Materdei, Naples, Italy, 80136</div></div></div>
      ...
      <div className="relative z-10 bg-[#050505] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="aspect-video w-full overflow-hidden rounded-sm border border-border md:aspect-[21/9]">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3017.7827295552984!2d14.244352099999999!3d40.8546938!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x133b0860b9115ff1%3A0x37c258254b4d49b4!2sNapoli%20Danza%20a.s.d.!5e0!3m2!1sen!2sit!4v1780071496851!5m2!1sen!2sit" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
        </div>
      </div>
    </section>
