...
export const brand = {
  ...
  logo: "",
  phone: "081 012 8718",
  phoneHref: "tel:+390810128718",
  whatsappHref: "https://wa.me/390810128718",
  email: "infonapolidanza@gmail.com",
  emailHref: "mailto:infonapolidanza@gmail.com",
  instagramHref: "https://www.instagram.com/vox_mundi_napoli/",
  facebookHref: "https://www.facebook.com/lovelydancebeautyfitnessvomero",
  mapsHref: "https://maps.google.com/?q=Via+Amato+Di+Montecassino+10%2Fb+80136+Naples+Italy",
  primaryLocation: "Via Amato Di Montecassino, 10/b",
  secondaryLocation: "80136 Naples",
  cityLine: "zona Materdei, Naples, Italy",
  hours:
...
export const featuredGalleryPhotos: { src: string; alt: string }[] = [
  { src: "/nostrimomenti1.jpg", alt: "Napoli Danza momento in sala" },
  { src: "/nostrimomenti2.jpg", alt: "Napoli Danza gruppo danza" },
  { src: "/nostrimomenti3.jpg", alt: "Napoli Danza lezione di danza" },
  { src: "/nostrimomenti4.jpg", alt: "Napoli Danza momento sul palco" },
  { src: "/nostrimomenti5.jpg", alt: "Napoli Danza allieve in scena" },
  { src: "/nostrimomenti6.jpg", alt: "Napoli Danza saggio di danza" },
]
...
export const salaArmoniaSchedule: ScheduleDay[] = [
  {
    ...
    classes: [
      ...
      { time: "11:00-12:00", name: "Flamenco" },
      { time: "14:00-15:00", name: "Gioco Danza" },
      { time: "17:00-18:00", name: "Danza Moderna" },
      { time: "19:00-20:00", name: "Predanza" },
      { time: "20:30-21:30", name: "Open Class" },
      { time: "21:30-22:30", name: "Hip Hop Kids" },
      { time: "22:30-23:30", name: "Hip Hop Teen" },
    ],
  },
  {
    day: "MARTEDÌ",
    classes: [
      ...
      { time: "14:00-15:00", name: "Predanza" },
      { time: "17:00-18:00", name: "Gioco Danza" },
      { time: "18:00-19:00", name: "Hip Hop Kids" },
      { time: "19:30-20:30", name: "Hip Hop Advanced" },
      { time: "20:30-21:30", name: "Flamenco" },
      { time: "21:30-22:30", name: "Danza Moderna" },
      { time: "22:30-23:30", name: "Open Class" },
    ],
  },
  {
    day: "MERCOLEDÌ",
    classes: [
      ...
      { time: "14:00-15:00", name: "Flamenco" },
      { time: "16:00-17:00", name: "Danza Moderna" },
      { time: "18:00-19:00", name: "Hip Hop Kids" },
      { time: "19:00-20:00", name: "Pilates" },
      { time: "20:30-21:30", name: "Hip Hop Teen" },
      { time: "21:30-22:30", name: "Open Class" },
    ],
  },
  {
    day: "GIOVEDÌ",
    classes: [
      ...
      { time: "14:00-15:00", name: "Predanza" },
      { time: "17:00-18:00", name: "Gioco Danza" },
      { time: "18:30-19:30", name: "Hip Hop Kids" },
      { time: "19:30-20:30", name: "Danza Moderna" },
      { time: "20:30-21:30", name: "Hip Hop Teen" },
      { time: "21:30-22:30", name: "Hip Hop Advanced" },
      { time: "22:30-23:30", name: "Open Class" },
    ],
  },
  {
    ...
    classes: [
      ...
      { time: "20:00-21:00", name: "Flamenco" },
      { time: "21:00-22:00", name: "Danza Moderna" },
      { time: "22:00-23:00", name: "Open Class" },
    ],
  },
  {
    day: "SABATO",
    classes: [
      ...
      { time: "15:30-16:30", name: "Hip Hop Kids" },
      { time: "17:00-18:00", name: "Hip Hop Advanced" },
    ],
  },
  {
    day: "DOMENICA",
    classes: [{ time: "10:00-12:30", name: "Open Class" }],
  },
]
...
export const scheduleContactInfo = {
  address: "Via Amato Di Montecassino, 10/b - zona Materdei, Naples, Italy, 80136",
  phone: "081 012 8718",
}
